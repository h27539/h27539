...
// 		}
// 		toStr(t,e=null) {
// 			try{return JSON.stringify(t)}catch{return e}
// 		}
// 		getjson(t,e) {
// 			let s=e;
...
// 		}
// 		setjson(t,e) {
// 			try{return this.setdata(JSON.stringify(t),e)}catch{return!1}
// 		}
// 		getScript(t) {
// 			return new Promise(e=>{this.get({url:t},(t,s,i)=>e(i))})
// 		}
// 		runScript(t,e) {
// 			return new Promise(s=>{let i=this.getdata("@chavy_boxjs_userCfgs.httpapi");
// 			i=i?i.replace(/\n/g,"").trim():i;
// 			let r=this.getdata("@chavy_boxjs_userCfgs.httpapi_timeout");
// 			r=r?1*r:20,r=e&&e.timeout?e.timeout:r;
// 			const[o,n]=i.split("@"),
// 			a={url:`http://${n}/v1/scripting/evaluate`,
// 			body:{script_text:t,
// 			mock_type:"cron",timeout:r},
